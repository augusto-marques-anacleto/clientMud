...
from gui.dialogs.settings import DialogoConfiguracoes, DialogoConfiguracoesGerais
from gui.dialogs.connection import DialogoEntrada, DialogoConectando, DialogoEditaPersonagem, EVT_RESULTADO_CONEXAO, ThreadIniciaConexao
...
from gui.theme import aplica_tema_se_ativo, aplica_tema
...
class PainelSessaoMud(wx.Panel):
    ...
    def renomeiaPersonagemConectado(self, chave_antigo, nome_novo):
        ...
        scripts e sons, título da aba e chave do personagem). Retorna True em
        caso de sucesso."""
        ...
        self.frame_principal.atualizaTituloAba(self, nome_novo)
        return True
